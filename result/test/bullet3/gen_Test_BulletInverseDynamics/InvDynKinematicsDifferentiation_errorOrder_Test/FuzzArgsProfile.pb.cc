...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_FuzzArgsProfile_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::AutoFuzz::FuzzArgsProfile, fuzzvar6_),
  PROTOBUF_FIELD_OFFSET(::AutoFuzz::FuzzArgsProfile, fuzzvar13_),
};
...
const char descriptor_table_protodef_FuzzArgsProfile_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\025FuzzArgsProfile.proto\022\010AutoFuzz\"6\n\017Fuz"
  "zArgsProfile\022\020\n\010fuzzvar6\030\001 \001(\021\022\021\n\tfuzzva"
  "r13\030\002 \001(\021b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_FuzzArgsProfile_2eproto = {
  false, false, descriptor_table_protodef_FuzzArgsProfile_2eproto, "FuzzArgsProfile.proto", 97,
...
FuzzArgsProfile::FuzzArgsProfile(const FuzzArgsProfile& from)
  ...
  ::memcpy(&fuzzvar6_, &from.fuzzvar6_,
    static_cast<size_t>(reinterpret_cast<char*>(&fuzzvar13_) -
    reinterpret_cast<char*>(&fuzzvar6_)) + sizeof(fuzzvar13_));
  // @@protoc_insertion_point(copy_constructor:AutoFuzz.FuzzArgsProfile)
}

void FuzzArgsProfile::SharedCtor() {
  ::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
      reinterpret_cast<char*>(&fuzzvar6_) - reinterpret_cast<char*>(this)),
      0, static_cast<size_t>(reinterpret_cast<char*>(&fuzzvar13_) -
      reinterpret_cast<char*>(&fuzzvar6_)) + sizeof(fuzzvar13_));
}
...
// @@protoc_insertion_point(message_clear_start:AutoFuzz.FuzzArgsProfile)
  ...
  ::memset(&fuzzvar6_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&fuzzvar13_) -
      reinterpret_cast<char*>(&fuzzvar6_)) + sizeof(fuzzvar13_));
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          fuzzvar6_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarintZigZag32(&ptr);
          CHK_(ptr);
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 16)) {
          fuzzvar13_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarintZigZag32(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* FuzzArgsProfile::_InternalSerialize(
  ...
  if (this->fuzzvar6() != 0) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteSInt32ToArray(1, this->_internal_fuzzvar6(), target);
  }

  // sint32 fuzzvar13 = 2;
  if (this->fuzzvar13() != 0) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteSInt32ToArray(2, this->_internal_fuzzvar13(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:AutoFuzz.FuzzArgsProfile)
  ...
  if (from.fuzzvar6() != 0) {
    _internal_set_fuzzvar6(from._internal_fuzzvar6());
  }
  if (from.fuzzvar13() != 0) {
    _internal_set_fuzzvar13(from._internal_fuzzvar13());
  }
}
...
void FuzzArgsProfile::InternalSwap(FuzzArgsProfile* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(FuzzArgsProfile, fuzzvar13_)
      + sizeof(FuzzArgsProfile::fuzzvar13_)
      - PROTOBUF_FIELD_OFFSET(FuzzArgsProfile, fuzzvar6_)>(
          reinterpret_cast<char*>(&fuzzvar6_),
          reinterpret_cast<char*>(&other->fuzzvar6_));
}
