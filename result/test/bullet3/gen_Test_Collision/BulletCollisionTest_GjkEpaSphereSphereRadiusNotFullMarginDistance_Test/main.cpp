...
*  .:: .:::            ::::...     .::.
*  .:: .:::      ...   .....::     .::.  Base UT: BulletCollisionTest_GjkEpaSphereSphereRadiusNotFullMarginDistance_Test
*  .:: .:::      .::.  ..::::.     .::.
...
extern "C" {
#endif
extern int autofuzz58;
extern int autofuzz59;
extern int autofuzz60;
extern int autofuzz61;
extern btScalar autofuzz72;
#ifdef __cplusplus
}
#endif
/*
...
void testSphereSphereDistance(SphereSphereTestMethod method, btScalar abs_error)
{
	...
	for (int rb = autofuzz58; rb < 5; rb++)
		for (int z = autofuzz59; z < 5; z++)
		{
			for (int j = autofuzz60; j < 5; j++)
			{
				for (int i = autofuzz61; i < 5; i++)
				{
...
{
	testSphereSphereDistance(SSTM_GJKEPA_RADIUS_NOT_FULL_MARGIN, autofuzz72);
}
...
#endif
void enterAutofuzz() {
  class AutofuzzTest : public ::BulletCollisionTest_GjkEpaSphereSphereRadiusNotFullMarginDistance_Test {
  public:
    void runTest() {
      try {
        SetUpTestCase();
