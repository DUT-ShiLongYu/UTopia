...
*  .:: .:::            ::::...     .::.
*  .:: .:::      ...   .....::     .::.  Base UT: BulletCollisionTest_AnalyticSphereSphereDistance_Test
*  .:: .:::      .::.  ..::::.     .::.
...
{
	testSphereSphereDistance(SSTM_ANALYTIC, autofuzz73);
}
...
#endif
void enterAutofuzz() {
  class AutofuzzTest : public ::BulletCollisionTest_AnalyticSphereSphereDistance_Test {
  public:
    void runTest() {
      try {
        SetUpTestCase();
