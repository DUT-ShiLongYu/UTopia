...
*  .:: .:::            ::::...     .::.
*  .:: .:::      ...   .....::     .::.  Base UT: BulletCollisionTest_GjkMPRSphereSphereDistance_Test
*  .:: .:::      .::.  ..::::.     .::.
...
{
	testSphereSphereDistance(SSTM_GJKMPR, autofuzz70);
}
...
#endif
void enterAutofuzz() {
  class AutofuzzTest : public ::BulletCollisionTest_GjkMPRSphereSphereDistance_Test {
  public:
    void runTest() {
      try {
        SetUpTestCase();
