...
*  .:: .:::            ::::...     .::.
*  .:: .:::      ...   .....::     .::.  Base UT: BulletCollisionTest_GjkEpaSphereSphereDistance_Test
*  .:: .:::      .::.  ..::::.     .::.
...
{
	testSphereSphereDistance(SSTM_GJKEPA, autofuzz71);
}
...
#endif
void enterAutofuzz() {
  class AutofuzzTest : public ::BulletCollisionTest_GjkEpaSphereSphereDistance_Test {
  public:
    void runTest() {
      try {
        SetUpTestCase();
