...
class FuzzArgsProfile PROTOBUF_FINAL :
 ...
 public:
  ...
  enum : int {
    kFuzzvar2FieldNumber = 1,
  };
  // float fuzzvar2 = 1;
  void clear_fuzzvar2();
  float fuzzvar2() const;
  void set_fuzzvar2(float value);
  private:
  float _internal_fuzzvar2() const;
  void _internal_set_fuzzvar2(float value);
  public:
...
// float fuzzvar2 = 1;
inline void FuzzArgsProfile::clear_fuzzvar2() {
  fuzzvar2_ = 0;
}
inline float FuzzArgsProfile::_internal_fuzzvar2() const {
  return fuzzvar2_;
}
inline float FuzzArgsProfile::fuzzvar2() const {
  // @@protoc_insertion_point(field_get:AutoFuzz.FuzzArgsProfile.fuzzvar2)
  return _internal_fuzzvar2();
}
inline void FuzzArgsProfile::_internal_set_fuzzvar2(float value) {
  
  fuzzvar2_ = value;
}
inline void FuzzArgsProfile::set_fuzzvar2(float value) {
  _internal_set_fuzzvar2(value);
  // @@protoc_insertion_point(field_set:AutoFuzz.FuzzArgsProfile.fuzzvar2)
}
