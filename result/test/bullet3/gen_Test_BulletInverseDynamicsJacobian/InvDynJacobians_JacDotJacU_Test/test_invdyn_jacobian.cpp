...
*  .:: .:::            ::::...     .::.
*  .:: .:::      ...   .....::     .::.  Base UT: InvDynJacobians_JacDotJacU_Test
*  .:: .:::      .::.  ..::::.     .::.
...
extern int autofuzz62;
extern btScalar autofuzz63;
extern int autofuzz68;
#ifdef __cplusplus
}
#endif
...
TEST(InvDynJacobians, JacDotJacU)
{
	...
	for (int level = autofuzz62; level < kNumLevels; level++)
	{
		const int nbodies = BT_ID_POW(autofuzz63, level);
	...
	int kMaxRandomBodies = autofuzz68;
...
#endif
void enterAutofuzz() {
  class AutofuzzTest : public InvDynJacobians_JacDotJacU_Test {
  public:
    void runTest() {
      try {
        SetUpTestCase();
